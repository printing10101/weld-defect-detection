...
SWRD 官方下载入口：tz-ndt.com（浏览器登录）或课题组 GitHub README 挂的
Google Drive 文件夹（bit628/RapidX-Annotator，境内网络通常不可达）。
本模块职责：
...
引用（比赛/论文须署名，DATA_LICENSE.md 已存 BibTeX）：
  Zhao, X. et al. "SWRD: A Dataset of Radiographic Image of Seam Weld for
  Defect Detection." J. Nondestruct. Eval. 44(2):50, 2025.
